    ...
    private void setStickerColor() {
        ...
        for (i = 0; i < size; i++) {
            for (TextView v : stickers.get(orders[i]).getView()) {
                ...
                if(v.getText().toString().contains("DIR"))
                    v.setBackgroundColor(Color.parseColor("#99ff66"));
                if(v.getText().toString().contains("DPOI"))
                    v.setBackgroundColor(Color.parseColor("#66ff99"));
                if(v.getText().toString().contains("EDF"))
                    v.setBackgroundColor(Color.parseColor("#999966"));
                if(v.getText().toString().contains("ELT/LN"))
                    v.setBackgroundColor(Color.parseColor("#d98cd9"));
                if(v.getText().toString().contains("FIL"))
                    v.setBackgroundColor(Color.parseColor("#e6ac00"));
                if(v.getText().toString().contains("FIS"))
                    v.setBackgroundColor(Color.parseColor("#b3b3cc"));
                if(v.getText().toString().contains("GEO"))
                    v.setBackgroundColor(Color.parseColor("#ffe6ff"));
                if(v.getText().toString().contains("GPOI"))
                    v.setBackgroundColor(Color.parseColor("#ccf2ff"));
                if(v.getText().toString().contains("INF"))
                    v.setBackgroundColor(Color.parseColor("#732673"));
                if(v.getText().toString().contains("INFL"))
                    v.setBackgroundColor(Color.parseColor("#5c85d6"));
                if(v.getText().toString().contains("ING"))
                    v.setBackgroundColor(Color.parseColor("#b3cccc"));
                if(v.getText().toString().contains("ITA"))
                    v.setBackgroundColor(Color.parseColor("#f0f5f5"));
                if(v.getText().toString().contains("LCS(I)"))
                    v.setBackgroundColor(Color.parseColor("#ffe6e6"));
                if(v.getText().toString().contains("MAT"))
                    v.setBackgroundColor(Color.parseColor("#cc8800"));
                if(v.getText().toString().contains("MATC"))
                    v.setBackgroundColor(Color.parseColor("#bf40bf"));
                if(v.getText().toString().contains("MECMAC"))
                    v.setBackgroundColor(Color.parseColor("#ffffe6"));
                if(v.getText().toString().contains("SCITA"))
                    v.setBackgroundColor(Color.parseColor("#C5E4DF"));
                if(v.getText().toString().contains("SI_CHI"))
                    v.setBackgroundColor(Color.parseColor("#7ED681"));
                if(v.getText().toString().contains("SI_FIS"))
                    v.setBackgroundColor(Color.parseColor("#81D3BD"));
                if(v.getText().toString().contains("SI_SCI"))
                    v.setBackgroundColor(Color.parseColor("#94B4C0"));
                if(v.getText().toString().contains("SIS_AUTO"))
                    v.setBackgroundColor(Color.parseColor("#95BFA0"));
                if(v.getText().toString().contains("SIS_AUTZ"))
                    v.setBackgroundColor(Color.parseColor("#B9BF95"));
                if(v.getText().toString().contains("SIS-R"))
                    v.setBackgroundColor(Color.parseColor("#84D0CC"));
                if(v.getText().toString().contains("SN_CHI/BIO"))
                    v.setBackgroundColor(Color.parseColor("#D2CC82"));
                if(v.getText().toString().contains("STO"))
                    v.setBackgroundColor(Color.parseColor("#CAD7DF"));
                if(v.getText().toString().contains("STO/CC"))
                    v.setBackgroundColor(Color.parseColor("#95ADBF"));
                if(v.getText().toString().contains("STO/GEO"))
                    v.setBackgroundColor(Color.parseColor("#F4DFEE"));
                if(v.getText().toString().contains("TEC/I"))
                    v.setBackgroundColor(Color.parseColor("#F3E7E0"));
                if(v.getText().toString().contains("TECM/PP"))
                    v.setBackgroundColor(Color.parseColor("#959CBF"));
                if(v.getText().toString().contains("TELE"))
                    v.setBackgroundColor(Color.parseColor("#E1EFF2"));
                if(v.getText().toString().contains("TP/SE"))
                    v.setBackgroundColor(Color.parseColor("#EEE0F3"));
                if(v.getText().toString().contains("TP/SI"))
                    v.setBackgroundColor(Color.parseColor("#BEBF95"));
                if(v.getText().toString().contains("TTRG"))
                    v.setBackgroundColor(Color.parseColor("#E4EEEF"));
